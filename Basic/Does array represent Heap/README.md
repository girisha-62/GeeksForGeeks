<h2><a href="https://practice.geeksforgeeks.org/problems/does-array-represent-heap4345/1?page=3&difficulty[]=-1&category[]=Arrays&sortBy=submissions">Does array represent Heap</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>A </strong>of size <strong>N</strong>, the task is&nbsp;to check if the given array represents a Binary Max Heap.</span></p>
