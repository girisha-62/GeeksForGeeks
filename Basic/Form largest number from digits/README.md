<h2><a href="https://practice.geeksforgeeks.org/problems/form-largest-number-from-digits5430/1?page=4&difficulty[]=-1&category[]=Arrays&sortBy=submissions">Form largest number from digits</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of numbers form <strong>0 to 9</strong>&nbsp;of size <strong>N</strong>. Your task is to rearrange elements of the array such that after combining all the elements of the array number formed is maximum.</span></p>
